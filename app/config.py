...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        return cls(
            ...
            openai_connect_timeout_seconds=max(_number("OPENAI_CONNECT_TIMEOUT_SECONDS", 5.0), 0.1),
            openai_read_timeout_seconds=max(_number("OPENAI_READ_TIMEOUT_SECONDS", 30.0), 0.1),
